  ...
  const projects = [
    {
      id: 1,
      title: "Jogo da Aura",
      description: "Jogo simples em HTML, CSS e JavaScript",
      tech: ["Html", "Javascript", "CSS"],
      image: "/projeto1.jpg",
      link: "https://johngabrielcoelho-dot.github.io/TheGame/index.html",
  ...
  return (
    <main className="relative bg-gradient-to-b from-black via-black to-blue-950/20 min-h-screen overflow-hidden">
      ...
      <div className="relative max-w-[900px] mx-auto px-6 z-10">
        ...
        <div id="contato" className="py-12 border-t border-gray-800 mt-12">
